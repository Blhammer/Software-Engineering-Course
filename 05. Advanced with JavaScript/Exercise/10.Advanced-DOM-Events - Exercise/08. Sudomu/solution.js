function solve() {
    ...
    function reset() {
        [...inputs].forEach(input => (input.value = ''));//[...inputs] -> array; to empty space
        table.style.border = 'none';// remove red border
        checkPar.textContent = ''; // remove text at the bottom line
    }
